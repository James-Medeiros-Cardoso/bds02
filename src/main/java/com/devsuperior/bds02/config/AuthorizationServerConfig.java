...
import com.devsuperior.bds02.components.JwtTokenEnhancer;
...
public class AuthorizationServerConfig extends AuthorizationServerConfigurerAdapter {
    ...
    @Autowired
    private JwtAccessTokenConverter jwtAccessTokenConverter; // JwtAccessTokenConverter
    ...
    @Autowired
    private JwtTokenEnhancer tokenEnhancer; // JwtTokenEnhancer
